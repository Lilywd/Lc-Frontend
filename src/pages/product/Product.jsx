        ...
        <div className='flex flex-col'>
            ...
            <div className='flex flex-col items-center gap-12'>
                ...
                <div className='flex flex-row justify-between gap-7'>
                    <button className=' text-black border font-semibold py-3 px-16 rounded-2 h-full'>Add to Cart</button>
                    <button className='bg-black text-white font-semibold py-3 px-16 rounded-2 h-full'>Add to Cart</button>
                </div>
